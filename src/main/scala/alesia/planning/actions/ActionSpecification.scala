...
case class SimpleActionDeclaration(name: String, initState: Option[ActionFormula] = None, simplePreCondition: ActionFormula = TrueFormula, effects: Seq[ActionEffect]) extends ActionDeclaration {
